...
import { CreatePlayerScreenForm } from "@/screen/form/create.player.screen.form";

export const CreatePlayerScreen = () => {
...
"
            ...
            <p className={"text-sm font-normal text-slate-400"}>
              Please enter your details to Player!
            </p>
          </div>
          <CreatePlayerScreenForm />
        </div>
      </div>
    </div>
  );
