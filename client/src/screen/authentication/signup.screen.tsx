...
import { SignUpScreenForm } from "@/screen/form/signup.screen.form";
...
export const SignUpScreen: React.FC = () => {
  return (
    <div className="flex items-center justify-center h-screen">
      <div
        className={
          "flex flex-col items-center justify-start w-[600px] h-[650px] bg-white p-4 border rounded-md shadow-md"
        }
      >
